...
\label{H_B4668F6C}
\matlabheading{Setting up and solving problems on quantum Graphs}

\matlabheadingtwo{A Schrodinger-Poisson problem}
...
$$\begin{array}{l}
\triangle u-V(x)\,u=f\\
\sum wu^{\prime } ({v_1 })+u({v_1 })=6\\
\sum wu^{\prime } ({v_2 })+u({v_2 })=3\\
u({v_3 })=\sech 2
\end{array}$$
\end{par}
...
\begin{matlabcode}
Phi=quantumGraph(s,t,L,'RobinCoeff',robinCoeff,'Weight',weight,'Discretization',discretizations{j});
...
\end{matlabcode}
\begin{matlaboutput}
Created directory data/dumbbell/181.
\end{matlaboutput}
...
Branch number 1.
Data saved to directory data/dumbbell/181/branch001.
...
Branch number 2.
Data saved to directory data/dumbbell/181/branch002.
...
N threshold 9.0 crossed.
Branch number 3.
Data saved to directory data/dumbbell/181/branch003.
No branching bifurcations found.
\end{matlaboutput}
...
Lambda threshold -3.0 crossed.
Branch number 4.
Data saved to directory data/dumbbell/181/branch004.
No branching bifurcations found.
\end{matlaboutput}
...
Lambda threshold -3.0 crossed.
Branch number 5.
Data saved to directory data/dumbbell/181/branch005.
...
Lambda threshold -3.0 crossed.
Branch number 6.
Data saved to directory data/dumbbell/181/branch006.
No branching bifurcations found.
\end{matlaboutput}
...
Lambda threshold -3.0 crossed.
Branch number 7.
Data saved to directory data/dumbbell/181/branch007.
No branching bifurcations found.
\end{matlaboutput}
...
\end{matlabcode}
\begin{matlaboutput}
File saved to data/dumbbell/181/savedFunction.001.
File number is 1. 
\end{matlaboutput}
\begin{matlabcode}
...
N threshold 9.0 crossed.
Branch number 8.
Data saved to directory data/dumbbell/181/branch008.
No branching bifurcations found.
\end{matlaboutput}
\begin{matlabcode}
