...
% order, plus a gray that I use a lot, which I call silver
...
% 6 -- cyanish
% 7 -- maroonish
% 8 -- silverish (not part of standard)
% 9 -- lightgray (not part of standard)
% 10-- eggshell  (not part of standard)
...
if isnumeric(varargin{1})
    ind=varargin{1};
    assert(round(ind)==ind&&ind>0&&ind<11,'k must be an integer between 1 and 10 \n')
elseif ischar(varargin{1})||isstring(varargin{1})
    ...
    error('input must be either an integer from 1 to 10, a character, or a string')
end
