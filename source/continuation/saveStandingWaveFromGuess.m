function fileNumber=saveHighStandingWaveFromGuess(dataDir,Lambda0,guess)
...
guessFileName=fullfile(dataDir,['savedGuess.' fileLabel]);
save(guessFileName,'guess','-ascii','-double')

addComment(dataDir,'savedFunction.%s was found using guess in savedGuess.%s ',fileLabel,fileLabel)
addComment(dataDir);
