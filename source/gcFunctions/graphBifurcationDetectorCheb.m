function [xBif,muBif,bifType]=graphBifurcationDetectorCheb(fcns,xGuess,muGuess)
...
if deficiency==0
    bifType=-1; fprintf('Fold point detected ')
else
    bifType=1; fprintf('Branch point detected ')
end
