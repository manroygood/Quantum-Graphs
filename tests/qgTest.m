...
L1=ones(1,4); weights=ones(1,5);
verifyError(testCase,@()quantumGraph(s,t,L1,'Weights',weights),'quantumGraph:weightMismatch');
% break robin coefficientse
robinCoeff=zeros(1,3);
G=quantumGraph(s,t,L1,'robinCoeff',robinCoeff);  
robinCoeff=ones(1,4);
